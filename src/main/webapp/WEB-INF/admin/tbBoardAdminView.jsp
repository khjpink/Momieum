    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          ...
          <form name="form_view" action="${cpath}/admin/tbBoardAdminWrite.do" enctype="multipart/form-data">
            <div class="card-body">
            ...
            <div class="card-footer text-right">
              ...
              <a href="${cpath}/admin/tbBoardAdminList.do" class="btn btn-default">목록</a>
            </div>
          </form>
        </div>
        <!-- 댓글 입력폼 -->
