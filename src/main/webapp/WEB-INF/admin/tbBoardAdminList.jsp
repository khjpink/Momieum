    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              ...
              <div class="input-group input-group-md">
                ...
                <form name="form_search" action="${cpath}/admin/tbBoardAdminList.do" method="GET" class="form-horizontal">
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover">
              ...
              <c:forEach var="vo" items="${list}" varStatus="i">
                ...
                <tr style="cursor: pointer;" onclick="location.replace('${cpath}/admin/tbBoardAdminView.do?bno=183');">
                  <td>${i.bdIdx}</td>
                  <td>NOTICE</td>
                  <td>${vo.bdTitle}</td>
        ...
        <div class="col-12 text-right">
          <a href="${cpath}/admin/tbBoardAdminWrite.do" class="btn btn-primary mb-3">글쓰기</a>
