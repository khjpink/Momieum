...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
           <a href="${cpath}/index2.do" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="${cpath}/admin/adminMain.do" class="brand-link">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="${cpath}/admin/dashBoard.do" class="nav-link active">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="${cpath}/admin/tbBoardAdminList.do" class="nav-link">
          ...
          <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="${cpath}/admin/boardMember_list.do" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>회원목록</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="${cpath}/admin/applyAdmin.do" class="nav-link">
