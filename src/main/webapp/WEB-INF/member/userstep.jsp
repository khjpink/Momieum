        ...
        <div class="con-area">
            ...
            <div class="section-heading">
                ...
                <div class="privacy-box">
                    ...
                    <strong class="sub-tit-02">
                        "그림으로 <span class="color-01">아이의 마음</span>을 읽고 <span class="color-01">나의 양육스트레스</span>를 알아보는 거에요."<br>
                        <span class="color-02">"궁금한 나와 아이의 마음</span>을 확인할 수 있어요"
                    </strong>
                    <p class="re-con-01">
                    ...
                    <strong class="sub-tit">개인정보제공ㆍ활용동의서</strong>
                ...
                <strong class="sub-tit sub-tit-01">수집ㆍ이용활용ㆍ제공 등의 동의여부</strong>
                <div class="txt-from-box">
                    ...
                    <span onclick="javascript:view_request_text()" style="cursor:pointer"><input type="button" class="ok-btn" id="btn_view_request_text" value="필독사항 &nbsp; 확인하고 &nbsp; 동의하기"></span>

                    <div id="request_text_box" style="display:none">
                        <div class="txt-info-box">
                            <strong>필독 사항</strong>
                            맘이음는 그림분석 이론을 기반으로 하고 있으나, 한 장의 그림만으로는 아동의 내면세계를 모두 알 수는 없습니다. 맘이음는 오프라인 상담과 같은 결과는 기대 하실 수 없습니다.
                            <br><br>
                            다만, 맘이음는 스크리닝용으로써 일상에서 가볍게, 상처받지 않고, 남의 눈치 보지 않고, 경제적이며 쉽고 편리하게 집에서 아동과 부모자신의 현재 정서현황에 대해 점검하고 적절히 대응하실 수 있도록 돕는 자가점검 서비스임을 알려드립니다.
                        </div>
                    </div>
                </div>
