                ...
                <div class="fill-form">
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="info-post">
                        <div class="icon">
                          <img src="${cpath}/resources/images/phone-icon.png" alt="">
                    ...
                    <div class="col-lg-4">
                      <div class="info-post">
                        <div class="icon">
                          <img src="${cpath}/resources/images/email-icon.png" alt="">
                          <a href="#">kim@email.com</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="info-post">
                        <div class="icon">
                          <img src="${cpath}/resources/images/location-icon.png" alt="">
                          <a href="#">광주 상무 평화로78</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
